...
RS485_DEVICE = {
    ...
    'fan': {
        ...
        'speed':    { 'id': '32', 'cmd': '43', 'ack': 'C3' },
        'mode':   { 'id': '32', 'cmd': '44', 'ack': 'C4' }
    }
}
...
DISCOVERY_DEVICE = {
    ...
    'mf': 'EzVille',
    'mdl': 'EzVille Wallpad',
    'sw': 'cjhdack/addon/ezville_wallpad',
}
...
#                                        onoff = 'off'
                            ...
                            # plug는 ACK PACKET에 상태 정보가 없으므로 STATE_PACKET만 처리
                                ...
                                if int(packet[14:16], 16) == 1:
                                    speedonoff = 'LOW' 
                                elif int(packet[14:16], 16) == 2:
                                    speedonoff = 'NORMAL'
                                elif int(packet[14:16], 16) == 3:
                                    speedonoff = 'HIGH'
                                elif int(packet[14:16], 16) == 0:
                                    speedonoff = 'OFF'
                                ...
                                await update_state(name, 'mode', rid, spc, modeonoff)
...
')
    ...
    mqtt_client = mqtt.Client(client_id='mqtt-ezville', protocol=mqtt.MQTTv311, callback_api_version=mqtt.CallbackAPIVersion.VERSION2)
